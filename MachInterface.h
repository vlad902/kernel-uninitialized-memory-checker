...
struct {
  ...
  { 2, IN, false, "mach_vm_page_range_query", "size" },
  { 3, IN, false, "mach_vm_page_range_query", "dispositions" },
  { 4, INOUT, false, "mach_vm_page_range_query", "dispositions_count" },
  ...
  { 0, IN, false, "mach_zone_info_for_zone", "host" },
  { 1, IN, false, "mach_zone_info_for_zone", "name" },
  { 2, OUT, false, "mach_zone_info_for_zone", "info" },
  ...
  { 7, IN, false, "memory_object_super_upl_request", "tag" },
  ...
  { 6, IN, false, "memory_object_upl_request", "tag" },
  ...
  { 0, IN, false, "task_inspect", "task" },
  { 1, IN, false, "task_inspect", "flavor" },
  { 2, OUT, true, "task_inspect", "info_out" }, // CountInOut, VARIABLE_SIZE
  { 3, INOUT, false, "task_inspect", "info_out_size" }, // Auto-generated
  ...
  { 0, IN, false, "vm_deallocate", "target" },
  ...
  { 0, IN, false, "vm_map_exec_lockdown", "target_task" },
